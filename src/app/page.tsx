    ...
    <main className="flex min-h-screen flex-col justify-between pt-10 pb-20 px-6">
      <div className="grid grid-cols-1 md:grid-cols-1   ">
        <div className=" sm:col-span-12 lg:col-span-1">
          <div className=" text-4xl md:text-2xl text-red-400 rounded-lg  underline pb-3">Old Testaments</div>
          <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-4 rounded-lg shadow-lg px-2 pb-6 pt-2">
        ...
        <div className=" sm:col-span-12 lg:col-span-1">
          <div className="text-4xl  md:text-2xl text-red-400 rounded-lg underline pb-3">New Testaments</div>
          <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-2 rounded-lg shadow-lg px-2 pb-6 pt-2">
